document.addEventListener('DOMContentLoaded', function() {
    ...
    function initSiemTabs() {
        ...
        // Carica la sidebar SIEM direttamente dalla directory principale
        fetch('sidebar.html')
            ...
            .then(html => {
                if (siemSidebar) {
                    ...
                    // Aggiungi eventi ai link della sidebar dopo il caricamento
                    const sidebarLinks = siemSidebar.querySelectorAll('a');
    ...
    function loadSiemContent(platform) {
        ...
        if (contentDiv) {
            ...
            // Carica i file direttamente dalla directory principale
            fetch(`${platform}.html`)
                .then(response => {
                    if (!response.ok) {
